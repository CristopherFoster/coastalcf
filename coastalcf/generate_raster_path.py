...
def generate_raster_path(sentinel_path, output_dir):
    """Genera la ruta de salida para el raster GeoTIFF."""
    return generate_output_path(sentinel_path, output_dir, "_TIF", "tif")